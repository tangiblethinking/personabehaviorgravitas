...
function Headline2({ displayValue }: { displayValue: string }) {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="🟢 Headline">
      <p className="css-1u11im font-['DM_Sans:Medium',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#111111] text-[16px] text-nowrap whitespace-pre outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50 rounded px-1">{displayValue}</p>
    </div>
  );
}

function Headline2Static({ displayValue }: { displayValue: string }) {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="🟢 Headline">
      <p 
...
function Content2({ displayValue }: { displayValue: string }) {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0" data-name="Content">
      <Overline2 />
      <Headline2 displayValue={displayValue} />
    </div>
  );
}

function Content2Static({ displayValue }: { displayValue: string }) {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0" data-name="Content">
      <Overline2 />
      <Headline2Static displayValue="1-12 Months" />
    </div>
  );
}
...
function Content2StaticRevenue({ revenueText }: { revenueText: string }) {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0" data-name="Content">
      ...
      <Headline2Static displayValue={revenueText} />
    </div>
  );
}

function StateLayer2({ displayValue, onHoverChange }: { displayValue: string; onHoverChange?: (isHovering: boolean, element: HTMLDivElement | null) => void }) {
  const divRef = useRef<HTMLDivElement>(null);
  ...
  return (
    ...
    >
      <LeadingElement2 />
      <Content2 displayValue={displayValue} />
    </div>
  );
}

function StateLayer2Static({ displayValue }: { displayValue: string }) {
  return (
    <div className="basis-0 box-border content-stretch flex gap-[16px] grow items-center min-h-px min-w-px pl-[16px] pr-0 py-[8px] relative shrink-0 pointer-events-none" data-name="state-layer">
      ...
      <Content2Static displayValue="1-12 Months" />
    </div>
  );
}
...
function MenuListItem2({ timeWithPlexus, onHoverChange }: { timeWithPlexus: string; onHoverChange?: (isHovering: boolean, element: HTMLDivElement | null) => void }) {
  return (
    <div className="content-stretch flex flex-col h-[40px] items-center relative rounded-[6px] shrink-0" data-name="Menu List Item">
      <StateLayer2 displayValue={timeWithPlexus} onHoverChange={onHoverChange} />
    </div>
  );
}
...
export default function Frame72({ personalityScore = 0, onHoverChange, onVIPHoverChange, onTimeHoverChange, onRevenueHoverChange }: Frame72Props) {
